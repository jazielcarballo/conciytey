...
//      body de la tabla
     ...
     * condicionar la url/texto a utilizar en el link (opcional)
     */
    public function imgLink($url_img, $action, $text = NULL, $boolean_field = NULL, $attr = NULL) {
        $url_img = explode('|', $url_img);
        $action = explode('|', $action);
        $text = explode('|', $text);
        ...
        $this->addFields(array(
            ...
            'boolean_field' => $boolean_field,
            'options' => array(
                Html::link("$action[0]/%s", '<i class=' . $url_img[0] . '></i>', 'class="btn  btn-mini btn btn-success tooltip_a" ' . $attr . ' data-toggle="tooltip"  title="'.$text[0].'" '),
                Html::link("$action[1]/%s", '<i class=' . $url_img[1] . '></i>', 'class="btn  btn-mini btn btn-danger tooltip_a"  ' . $attr . ' data-toggle="tooltip"  title="'.$text[1].'" '),
            )
        ));
    }
    ...
    public function imgLinkConfirm($url_img, $action, $text = NULL, $confirm = '¿Esta Seguro?', $boolean_field = NULL) {
        ...
        $this->addFields(array(
            ...
            'options' => array(
                ...
                Js::link("$action[0]/%s", '<i class=' . $url_img[0] . '></i>', $confirm[0], 'btn  btn-mini btn btn-danger'),
                Js::link("$action[1]/%s", '<i class=' . $url_img[1] . '></i>', $confirm[1], 'btn  btn-mini btn btn-danger'),
            )
        ));
    }

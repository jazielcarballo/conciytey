...
if (!defined('K_PATH_FONTS')) {
    define('K_PATH_FONTS', K_PATH_MAIN.APP_PATH . 'libs/tcpdf/fonts/');
}
...
if (!defined('K_PATH_URL')) {
    ...
    if (isset($_SERVER['HTTP_HOST']) AND (!empty($_SERVER['HTTP_HOST']))) {
        ...
        $k_path_url .= $_SERVER['HTTP_HOST'].PUBLIC_PATH;
...
if (!defined('K_PATH_IMAGES')) {
    //$tcpdf_images_dirs = array(K_PATH_MAIN.'public/img/', K_PATH_MAIN.'images/', '/usr/share/doc/php-tcpdf/examples/images/', '/usr/share/doc/tcpdf/examples/images/', '/usr/share/doc/php/tcpdf/examples/images/', '/var/www/tcpdf/images/', '/var/www/html/tcpdf/images/', '/usr/local/apache2/htdocs/tcpdf/images/', K_PATH_MAIN);
...
if (!defined('PDF_HEADER_LOGO')) {
    ...
    if (@file_exists(K_PATH_IMAGES.'conciytey.png')) {
        $tcpdf_header_logo = 'conciytey.png';
    }

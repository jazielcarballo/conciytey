      ...
      <section>
          ...
          <?php if(isset($_SESSION['fenaci'])): ?>
                 <div class="large-3 medium-3 small-6 columns usuario text-right">
                    <img src="img/ic-user.jpg" alt=""> <a href="perfil.php"><?= $_SESSION['fenaci']["nombre"] ?></a> 
...
-->                  <li><a href="feria.php">LA FERIA</a></li>
                ...
                <ul class="right">
                  <li class="active2"><a href="docs/convocatoria-feria-estatal-de-ciencias-e-ingenierias.pdf" target="_blank">BASES</a></li>
                </ul>
              </section>
            </nav>
      </section>
    ...
    <section class="banner hide-on-print">
    	<img src="img/logo_banner/thumbnail/1200thumb_<?= $banner ?>" title="banner"/>
    </section>
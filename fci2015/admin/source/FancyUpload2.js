...
FancyUpload2.File = new Class({
	...
	onComplete: function() {
		...
		this.base.currentText.set('html', 'Completado');
...
(function() {
	var phrases = {
		'progressOverall': 'Progreso global ({total})',
		'currentTitle': 'Archivo en progreso',
		'currentFile': 'Subiendo "{name}"',
		'currentProgress': 'Subir: {bytesLoaded} with {rate}, {timeRemaining} remaining.',
		'fileName': '{name}',
		'remove': 'Borrar',
		'removeTitle': 'Haga clic para borrar.',
